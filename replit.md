...
- July 12, 2025: Implemented flexible computational settings for Step 5 radiation analysis with four precision options: Hourly (13 hours × 365 days = 4,745 calculations), Daily Peak (noon × 365 days = 365 calculations), Monthly Peak (noon × 12 peak days = 12 calculations), and Yearly Average (summer solstice representative = 1 calculation), with proper scaling factors for accurate annual radiation values (kWh/m²/year) and deployment automatic fallback to Daily Peak method for resource optimization
