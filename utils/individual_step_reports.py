...
def generate_step2_report():
    ...
    return (get_base_html_template('Historical demand and scenarios', 2)
            + demand_section(st.session_state.get('project_data', {})) + get_footer_html())
...
def generate_step9_report():
    ...
    data = db_manager.get_financial_analysis(project_id) if project_id else {}
    return (get_base_html_template('Financial scenario', 9)
            + financial_section(data or {}) + get_footer_html())
